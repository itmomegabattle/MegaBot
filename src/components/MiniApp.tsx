                    ...
                    <div key={user.id} className={`rounded-3xl border border-blue-100 bg-white p-4 shadow-sm ${pressClass}`} onClick={() => setExpandedUserId(expanded ? null : user.id)}>
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="text-right">
                          ...
                          <div className={`mt-1 rounded-full px-2.5 py-1 text-[10px] font-black ${user.registered ? 'bg-emerald-50 text-emerald-700' : 'bg-slate-100 text-slate-700'}`}>
                                    ...
                                    <>
                                      <div className="flex items-start justify-between gap-3">
                                        <div>
                                          ...
                                          <div className={`mt-1 inline-flex rounded-full px-2.5 py-1 text-[10px] font-black ${user.registered ? 'bg-emerald-50 text-emerald-700' : 'bg-slate-100 text-slate-700'}`}>
