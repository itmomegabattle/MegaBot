...
- единственный рабочий лист доступности: `ОСНОВА` (`sheetId: 432131861`); переименование не ломает интеграцию, потому что главным идентификатором остаётся `sheetId`;
...
Команда создаёт полный дубликат с названием вида `РЕЗЕРВ ОСНОВА 2026-08-05 13-00-00`.
